      ...
      <div className="flex flex-col">
        ...
        <Section title="読書画面の操作">
          <ul className="list-disc pl-5">
            ...
            <li>
              設定の「ページ送り」で表示方式を切り替えられます。「スクロール」は連続スクロール、「ページ送り」は画面ぴったりの1ページ単位でタップしてめくる方式です（横書きは左右タップで前後のページ、縦書きは左右が逆になり左タップで次ページ・右タップで前ページ、中央タップで表示切替）。
            </li>
            <li>
              フッターの「次の話」「前の話」で話を移動できます。スクロールモードでは、本文の最後にいる状態で画面左側をダブルタップすると次の話に移動します。
            </li>
        ...
        <Section title="検索・タグ・お気に入り">
          <ul className="list-disc pl-5">
            <li>本棚画面右上の虫眼鏡アイコンから、小説名の一部やサイト（なろう/カクヨム/ハーメルン等）で本棚内の作品を絞り込めます。</li>
            <li>作品詳細画面でタグを自由に追加・削除できます。</li>
            <li>本棚の各作品行のハートアイコン、または読書画面のハートアイコンでお気に入り登録できます。</li>
          </ul>
        </Section>
      </div>
    </div>
